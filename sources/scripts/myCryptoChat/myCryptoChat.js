                ...
                for (i = 0; i < data.chatLines.length; i++) {
                    try {
                        ...
                        if (vizhash.supportCanvas()) {
                            ...
                            chatRoom.append(" <b>" + htmlEncode(user) + "</b> : " + replaceUrlTextWithUrl(htmlEncode(decryptedMessage)) + "<br />");
                        } else {
                            chatRoom.append("<i>" + data.chatLines[i].date + "</i> - <b>" + htmlEncode(user) + "</b> : " + replaceUrlTextWithUrl(htmlEncode(decryptedMessage)) + "<br />");
                        }
                    } catch (e) {
                        hasErrors = true;
                    }
